...
def get_filename(experiment_name,circuit_type,circuit_size,device_size,device_name,field):
    assert field in ['evaluator_input','collapse_input','reconstructor_input','reconstructor_output']
    dirname = './%s/%s/%s_%d/%d'%(experiment_name,circuit_type,device_name,device_size,circuit_size)
    filename = '%s'%field
